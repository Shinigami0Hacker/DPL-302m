...
def update_parameters_with_momentum_test_case():
    ...
    v = {'dW1': np.array([[0., 0., 0.], [0., 0., 0.]]), 'dW2': np.array([[0., 0.], [0., 0.], [0., 0.]]),
         'db1': np.array([[0.], [0.]]), 'db2': np.array([[0.], [0.], [0.]])}
...
def update_parameters_with_adam_test_case():
    ...
    v, s = ({'dW1': np.array([[0., 0., 0.],  # (2, 3)
                              [0., 0., 0.]]), 'dW2': np.array([[0., 0.],  # (3, 2)
                                                               [0., 0.], [0., 0.]]), 'db1': np.array([[0.],  # (2, 1)
                                                                                                      [0.]]),
             'db2': np.array([[0.],  # (3, 1)
                              [0.], [0.]])}, {'dW1': np.array([[0., 0., 0.],  # (2, 3)
                                                               [0., 0., 0.]]), 'dW2': np.array([[0., 0.],  # (3, 2)
                                                                                                [0., 0.], [0., 0.]]),
                                              'db1': np.array([[0.],  # (2, 1)
                                                               [0.]]), 'db2': np.array([[0.],  # (3, 1)
                                                                                        [0.], [0.]])})
    W1 = np.random.randn(2, 3)
    b1 = np.random.randn(2, 1)
    W2 = np.random.randn(3, 2)
