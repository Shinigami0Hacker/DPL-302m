...
def identity_block_test(target):
    ...
    assert np.allclose(resume, 
                       ...
                       atol = 1), "Wrong values with training=False"
    ...
    assert np.allclose(resume, 
                         np.array([[[0.,         0.,         0.,         0.,        ],
                                 ...
                                 [[3.2380054,  4.1391973,  4.1391973,  3.2380054 ],
                                  [3.2380054,  4.1391973,  4.1391973,  3.2380054 ]]]),
                       atol = 1), "Wrong values with training=True"
...
def convolutional_block_test(target):
    ...
    assert np.allclose(B.numpy(), convolutional_block_output2, atol= 1), "Wrong values when training=True."
