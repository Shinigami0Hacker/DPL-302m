...
from keras.layers import concatenateimport tensorflow as tf
import numpy as np
    ...
    def show_predictions(dataset=None, num=1):
        ...
        if dataset:
            for image, mask in dataset.take(num):
                ...
                ImageSegmentation.display_input_and_mask([image[0], mask[0], ImageSegmentation.create_mask(pred_mask)])
        else:
...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            ImageSegmentation.model_initialize()
            ImageSegmentation.model_summary()
        elif choice == 6:
            ImageSegmentation.unet_training()
        elif choice == 7:
            ImageSegmentation.evaluation()
        elif choice == 8:
