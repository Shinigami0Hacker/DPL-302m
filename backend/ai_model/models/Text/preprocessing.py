...
def reduce_lengthening(text: str) -> str:
    ...
    :param text: The input text containing potential character lengthening.
    :return: The text with consecutive character lengthening reduced.
    """
...
def text_preprocess(doc: str) -> str:
    ...
    :param doc: The input document to be preprocessed.
